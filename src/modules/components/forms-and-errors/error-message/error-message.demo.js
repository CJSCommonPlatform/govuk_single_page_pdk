...
var ErrorMessageDemo = (function () {
    ...
    ErrorMessageDemo.prototype.submitForm = function () {
        console.log('Submit form: This gets called only when form is valid');
    };
    ;
    ErrorMessageDemo = __decorate([
        angularjs_devtools_1.Component({
            template: require('./error-message.demo.html')
        })
    ], ErrorMessageDemo);
    return ErrorMessageDemo;
}());
exports.ErrorMessageDemo = ErrorMessageDemo;
//# sourceMappingURL=error-message.demo.js.map