...
var VideoComponent = (function () {
    function VideoComponent($element, $window /*ng.IWindowService*/) {
    ...
    VideoComponent.prototype.$onInit = function () {
        var holder = angular.element('<span></span>');
        this.$element.append(holder);
        holder.player(this.config, this.$window.jwconfig);
    };
    VideoComponent.$inject = ['$element'];
