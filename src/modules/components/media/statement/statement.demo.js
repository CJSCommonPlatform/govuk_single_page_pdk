...
var StatementDemo = (function () {
    ...
    StatementDemo.prototype.onSelect = function (filename) {
        alert(filename);
    };
    StatementDemo = __decorate([
        angularjs_devtools_1.Component({
            template: require('./statement.demo.html')
        })
    ], StatementDemo);
    return StatementDemo;
}());
exports.StatementDemo = StatementDemo;
//# sourceMappingURL=statement.demo.js.map